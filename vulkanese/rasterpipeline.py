...
class RasterPipeline(Pipeline):
    ...
    def createVertexBuffers(self):
        ...
        allBufferDescriptions = self.vertexShaderInputBuffers + self.vertexShaderInputBuffersNoDebug  + self.vertexShaderOutputBuffers
    ...
    def createFragmentBuffers(self):
        ...
        # if we're debugging, all intermediate variables become output buffers
        allBufferDescriptions = self.fragmentShaderInputBuffers + self.fragmentShaderOutputBuffers
    ...
    def createGraphicPipeline(self,
