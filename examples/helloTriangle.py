...
pyramidVerticesPos = \
np.array([[0.0, -0.5, 0.5], [0.5, 0.5, 0.5], [-0.5, 0.5, 0.5], [0.0, -0.5, -0.5], [-0.5, 0.5, -0.5]], dtype=np.dtype('f4'))
...
while running:
	...
	pyramidMesh.rotate(R, center=(0,0,0))
	meshVert = np.asarray(pyramidMesh.vertices, dtype = 'f4')
	#print(np.asarray(pyramidMesh.triangles))
